    ...
    def test_spins(self):
        ...
        self.assertEqual(
            ['p + 7Li → 2·4He + 17346 keV                             stable, α                 1/2+, 3/2-           0+, 0+',
             ...
             'p + 7Li → t + 5Li + -4434 keV                           t, →β-                    1/2+, 3/2-           1/2+, 3/2-',
             ...
             'p + 7Li → n + d + 5Li + -10691 keV                      n, n-transfer, →β-        1/2+, 3/2-           1+, 1/2+, 3/2-',
             'p + 7Li → ɣ + 8Be (j) + -10240 keV                      ɣ                         1/2+, 3/2-           0+ T=2, 1-',
             'p + 7Li → n + 7Be + -1644 keV                           n, →β-                    1/2+, 3/2-           1/2+, 3/2-',
             ...
             'p + 7Li → 2·n + 6Be + -12322 keV                        n, →β-                    1/2+, 3/2-           0+, 1/2+, 1/2+',
             'p + 7Li → n + 7Be (i) + -12625 keV                      n, →β-                    1/2+, 3/2-           1/2+, 3/2- T=3/2',
             'p + 7Li → n + t + 4Li + -26145 keV                      n, t, →β-                 1/2+, 3/2-           1/2+, 1/2+, 2-',
             'p + 7Li → n + 3Li + 4H + -39165 keV                     n, →β-                    1/2+, 3/2-           1/2+, 2-']
    ...
    def test_output(self):
        ...
        self.assertEqual(
            ['p + 7Li → d + 6Li + -5027 keV                           n-transfer, stable            ✓ 7Li [L15],   ✓ 6Li [L15]',
             ...
             'p + 7Li → t + 5Li + -4434 keV                           t, →β-                        ✓ 7Li [L15]',

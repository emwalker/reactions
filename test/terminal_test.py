    ...
    def test_spins(self):
        ...
        self.assertEqual(
            ['p + 7Li → 2·4He + 17346 keV                             in nature, α              1/2+, 3/2-           0+, 0+',
             ...
             'p + 7Li → d + 3He + t + -20821 keV                      n-transfer, t, trace, →β- 1/2+, 3/2-           1+, 1/2+, 1/2+',
             'p + 7Li → p + 7Li + 0 keV                               in nature                 1/2+, 3/2-           1/2+, 3/2-',
             'p + 7Li → p + t + 4He + -2468 keV                       t, trace, α, →β-          1/2+, 3/2-           0+, 1/2+, 1/2+',
             'p + 7Li → 3He + 5He + -3966 keV                         →n                        1/2+, 3/2-           1/2+, 3/2-',
             'p + 7Li → t + 5Li + -4434 keV                           t, trace, →p, →β-         1/2+, 3/2-           1/2+, 3/2-',
             ...
             'p + 7Li → n + 7Be + -1644 keV                           n, trace, →β-, →ε         1/2+, 3/2-           1/2+, 3/2-',
             ...
             'p + 7Li → n + t + 4Li + -26145 keV                      n, t, trace, →p, →β-      1/2+, 3/2-           1/2+, 1/2+, 2-',
    ...
    def test_references(self):
        ...
        self.assertEqual(
            ['p + 7Li → 2·4He + 17346 keV                             in nature, α',
             ...
             'p + 7Li → d + 3He + t + -20821 keV                      n-transfer, t, trace, →β-',
             'p + 7Li → p + 7Li + 0 keV                               in nature                     ✗ 7Li [L15]',
             'p + 7Li → p + t + 4He + -2468 keV                       t, trace, α, →β-',
             'p + 7Li → 3He + 5He + -3966 keV                         →n',
             'p + 7Li → t + 5Li + -4434 keV                           t, trace, →p, →β-',
    ...
    def test_output(self):
        ...
        self.assertEqual(
            ['p + 7Li → d + 6Li + -5027 keV                           in nature, n-transfer         ✓ 7Li [L15],   ✓ 6Li [L15]',
             'p + 7Li → t + 5Li + -4434 keV                           t, trace, →p, →β-             ✓ 7Li [L15]',
             ...
             'p + 7Li → p + t + 4He + -2468 keV                       t, trace, α, →β-              ✓ 7Li [L15]',
             'p + 7Li → p + 3He + 4H + -24644 keV                     →n                            ✓ 7Li [L15]',
             'p + 7Li → 2·d + 4He + -6500 keV                         in nature, n-transfer, α      ✓ 7Li [L15]',
             'p + 7Li → d + 3He + t + -20821 keV                      n-transfer, t, trace, →β-     ✓ 7Li [L15]',

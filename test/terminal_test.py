    ...
    def test_spins(self):
        ...
        self.assertEqual(
            ['p + 7Li → 2·4He + 17346 keV                             stable, α                 1/2+, 3/2-           0+, 0+',
             ...
             'p + 7Li → ɣ + 8Be (i) + 628 keV                         ɣ, →α                     1/2+, 3/2-           1-, 2+ frg T=1',
             ...
             'p + 7Li → d + 6Li (i) + -8589 keV                       n-transfer, →IT           1/2+, 3/2-           0+ T=1, 1+',
             ...
             'p + 7Li → ɣ + 8Be (j) + -10240 keV                      ɣ, →n, →α                 1/2+, 3/2-           0+ T=2, 1-',
             ...
             'p + 7Li → n + p + 6Li (i) + -10814 keV                  n, →IT, →β-               1/2+, 3/2-           0+ T=1, 1/2+, 1/2+',
    ...
    def test_references(self):
        ...
        self.assertEqual(
            ['p + 7Li → 2·4He + 17346 keV                             stable, α',
             ...
             'p + 7Li → d + 6Li (i) + -8589 keV                       n-transfer, →IT               ✓ 6Li [L15]',
    ...
    def test_output(self):
        ...
        self.assertEqual(
            ['p + 7Li → d + 6Li + -5027 keV                           n-transfer, stable            ✓ 7Li [L15],   ✓ 6Li [L15]',
             'p + 7Li → d + 6Li (i) + -8589 keV                       n-transfer, →IT               ✓ 7Li [L15],   ✓ 6Li [L15]',
